...
require('lazy').setup({
  ...
  -- "gc" to comment visual regions/lines
  {
    ...
    opts = {
      -- Line style comments will use 'gl', and 'glc' as line comment toggle
      --[[ Block style comments will use 'gc', and 'gcc' as line comment toggle ]]
      toggler = {
        line = 'glc',
        block = 'gcc',
      },
  ...
  { -- LSP Configuration & Plugins
    ...
    dependencies = {
      ...
      -- `lazydev` (in place of neodev) configures Lua LSP for your Neovim config, runtime and plugins
